...
public class OrderServiceImplTest {
    ...
    private final String BUYER_OPENID = "1110000";

    private final String ORDER_ID = "1501313876469613919";

    @Test
    public void create() throws Exception {

        OrderDTO orderDTO = new OrderDTO();
        orderDTO.setBuyerName("傻石羊");
        orderDTO.setBuyerAddress("孝感");
        orderDTO.setBuyerPhone("1236977");
